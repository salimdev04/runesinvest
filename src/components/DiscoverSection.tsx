    ...
    return (
        <section className={commonStyles.padding} >
            <div className={["flex justify-around pb-8 items-center"].join(' ')}>
                <div >
                    <h1 className={h1Title}> <span className="">ONE KEY</span> <br /> <span className="tablet:ml-[4rem]">TO RULE THEME </span> <br /> ALL</h1>
                ...
                <div className={["", commonStyles.hiddenOnMobile].join(" ")}>
                    <img src="/runes-key.png" alt="" className=" max-w-[616px] max-h-[600px]" />
                </div>
            </div>
