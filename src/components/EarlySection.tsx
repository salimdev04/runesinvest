...
export default function EarlySection() {
    return (
        <div>
            <section className={[commonStyles.padding, "hidden tablet:block"].join(' ')} >
                <div className={["flex justify-around pb-8 items-center"].join(' ')}>
                    <div >
                        <h1 className={h1Title}> Being Early Matters <br />Open the Runes Gate with <br />your Forged Keys</h1>
                    ...
                    <div className={["", commonStyles.hiddenOnMobile].join(" ")}>
                        <img src="/runes-side.png" alt="" className=" max-w-[616px]" />
                    </div>
                </div>
